...
function NonStickyForm() {
  ...
  return (
    <div className="sm:flex   flex-col md:flex-row  sm:mx-6 sm:mt-5 hidden">
    <div className="top-10 z-10 sm:min-w-[100%] min-w-[400px]">
      ...
      <div className="bg-white border p-4 flex flex-col gap-3 mt-4">
        <p className="text-xl text-[#093097] font-extrabold">
          Brochures
        </p>
